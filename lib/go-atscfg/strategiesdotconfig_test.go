...
// Benchmarks
func BenchmarkMakeStrategiesDotConfig(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
	...
	// resetting the timer so we can get a proper reading
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		MakeStrategiesDotYAML(dses, server, servers, topologies, serverParams, parentConfigParams, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
	}
}

func BenchmarkMakeStrategiesTopologiesParams(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
...
func BenchmarkMakeStrategiesHTTPSOrigin(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
...
func BenchmarkMakeStrategiesPeeringRing(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
	...
	b.ResetTimer()
	b.Run("peering ring true", func(b *testing.B) {
		parentConfigParamsPR := make([]tc.Parameter, len(parentConfigParams), len(parentConfigParams))
		copy(parentConfigParamsPR, parentConfigParams)
		parentConfigParamsPR = append(parentConfigParamsPR, tc.Parameter{
			Name:       StrategyConfigUsePeering,
		...
		for i := 0; i < b.N; i++ {
			MakeStrategiesDotYAML(dses, edge0, servers, topologies, serverParams, parentConfigParamsPR, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
		}
	})
	b.Run("peering ring false", func(b *testing.B) {
		parentConfigParamsPR := make([]tc.Parameter, len(parentConfigParams), len(parentConfigParams))
		copy(parentConfigParamsPR, parentConfigParams)
		parentConfigParamsPR = append(parentConfigParamsPR, tc.Parameter{
			Name:       StrategyConfigUsePeering,
	...
	b.Run("peering ring nonexistent", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			MakeStrategiesDotYAML(dses, edge0, servers, topologies, serverParams, parentConfigParams, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
		}
	})
}

func BenchmarkMakeStrategiesPeeringRingMSO(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
...
func BenchmarkMakeStrategiesPeeringRingNonTopology(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
...
func BenchmarkMakeStrategiesDotYAMLFirstLastNoTopoParams(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment", GoDirect: "true"}
...
func BenchmarkMakeStrategiesDotYamlMSONoTopologyNoMid(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment"}
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		MakeStrategiesDotYAML(dses, mid, servers, topologies, serverParams, parentConfigParams, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
	}
}

func BenchmarkMakeStrategiesDotYAMLFirstInnerLastParams(b *testing.B) {
	opt := &StrategiesYAMLOpts{VerboseComments: false, HdrComment: "myHeaderComment", GoDirect: "true"}
	...
	b.Run("Edge config", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			for _, ds := range dsesall {
				dses := []DeliveryService{ds}
				MakeStrategiesDotYAML(dses, edge, servers, topologies, serverParams, parentConfigParams, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
			}
		}
	})
	...
	b.Run("Opl config", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			for _, ds := range dsesall {
				dses := []DeliveryService{ds}
				MakeStrategiesDotYAML(dses, opl0, servers, topologies, serverParams, parentConfigParams, serverCapabilities, dsRequiredCapabilities, cgs, dss, cdn, opt)
			}
		}
	})
}
